...
public abstract class BaseDao {
    protected Connection getConnection() throws SQLException {
        ...
        String conn = "jdbc:sqlserver://fiap-on-esoa3-agnello.database.windows.net:1433;database=vinheria_agnello;user={user}@{db_name};password={password};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;"
                .replace("{user}", user)
                .replace("{db_name}", db)
